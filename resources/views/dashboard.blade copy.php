            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    for(var i=0; i<len; i++){
                        ...
                        var tr_str = "<div class='card border border-primary' id = 'singlemovie'> " +
                        ...
                        for (var j = 0; j < cinemas_length; j++) {
                            ...
                            cn_str += "<br><br><div class= 'row'><div class='border-left border-primary' id = 'singlemovie'> " +
                            "<p align='center'>" + thiscinemas.name + "</p></div>";
                            // $("#movies").append(cn_str);
                            var schedule = response.data[i].schedules[j].showtime;
                            cn_str += "<br><br><div class=' row border-left border-primary' id = 'schedule'> " +
                            "<div align='center'>" + schedule + "</div></div>";
                        }
                        cn_str += "</div>";
                        $("#movies").append(cn_str);
